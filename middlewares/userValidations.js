...
const userCreateValidation = () => {
    return [
        ...
        body("email").isString().withMessage("O email é obrigatório.").isEmail().withMessage("O campo precisa ser um email."),
        ...
        body("confirmPassword").isString().withMessage("A confirmação é obrigatória.").custom((value, {req}) => {
